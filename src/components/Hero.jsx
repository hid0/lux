...
export default function Hero() {
  ...
  return (
    <section className="flex items-center hero">
      ...
      <div className="w-full inset-0 md:relative md:w-1/2">
        <div className="relative hero-image">
          ...
          <div className="overlay right-0 bottom-0 md:inset-0">
            <button className="video hero-cta focus:outline-none z-30 modal-trigger" onClick={handlerShowModal} />
          </div>
      ...
      {showModal && <Modal handlerShowModal={handlerShowModal} />}
    </section>
  )
}